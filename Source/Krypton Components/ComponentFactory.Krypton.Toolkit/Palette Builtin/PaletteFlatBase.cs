...
{
    public abstract class PaletteFlatBase : PaletteBase
    {
        ...
        private KryptonColorTableFlat _table;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the PaletteFlatBase class.
        /// </summary>
        ...
        public PaletteFlatBase(Color[] schemeColors,
        ...
        public override IRenderer GetRenderer()
        {
            ...
            return KryptonManager.RenderFlat;
        }
        #endregion
                ...
                case PaletteBackStyle.ContextMenuItemHighlight:
                    switch (state)
                    {
                        ...
                        case PaletteState.Normal:
                            return PaletteColorStyle.Linear;
                        case PaletteState.Tracking:
                            return PaletteColorStyle.Solid; // Вместо ExpertTracking для рисования плоской кнопки
                        case PaletteState.Pressed:
                        case PaletteState.CheckedPressed:
                            return PaletteColorStyle.Solid; // Вместо ExpertPressed
                        case PaletteState.CheckedNormal:
                            return PaletteColorStyle.ExpertChecked;
                        case PaletteState.CheckedTracking:
        ...
        protected override void DefineFonts()
        {
            ...
            // шрифт заголовка
            _header1ShortFont = new Font(baseFontName, baseFontSize + 0.0f, FontStyle.Bold); 
            ...
            // шрифт дополнения заголовка
            _header1LongFont = new Font(baseFontName, baseFontSize + 0.0f, FontStyle.Regular); 
        ...
        public override KryptonColorTable ColorTable
        {
            ...
            {
                if (_table == null)
                    _table = new KryptonColorTableFlat(_ribbonColors, InheritBool.False, this);
